import { useRecentShops } from '@shopify/shop-minis-react'
...
export function RecentShops() {
  ...
  return (
    <div className="space-y-4">
      ...
      {loading && <p className="text-blue-600">Loading recent shops...</p>}
      ...
      <div className="space-y-3">
        {shops && shops.length > 0 ? (
          ...
          <p className="text-gray-500">No recent shops visited</p>
        )}
      </div>
