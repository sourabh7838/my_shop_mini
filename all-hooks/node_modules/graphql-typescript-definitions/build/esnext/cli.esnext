...
import { ExportFormat, EnumFormat } from './types.esnext';
import { Builder } from './index.esnext';

/* eslint no-console: off */
const argv = yargs.usage('Usage: $0 [options]').option('watch', {
  required: false,
  default: false,
  type: 'boolean',
  ...
  choices: [ExportFormat.Document, ExportFormat.TypedDocumentNode, ExportFormat.DocumentWithTypedDocumentNode, ExportFormat.Simple]
}).option('enum-format', {
  required: false,
  describe: 'The format in which to generate case names for enum types in the schema',
  choices: [EnumFormat.CamelCase, EnumFormat.PascalCase, EnumFormat.SnakeCase, EnumFormat.ScreamingSnakeCase]
