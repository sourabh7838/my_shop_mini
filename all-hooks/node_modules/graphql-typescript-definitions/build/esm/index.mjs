...
export { EnumFormat, ExportFormat } from './types.mjs';
import { generateSchemaTypes } from './print/schema/index.mjs';
import { printDocument } from './print/document/index.mjs';
export { AbstractGraphQLFilesystem } from './filesystem/graphql-filesystem.mjs';
...
async function defaultFilesytem() {
  ...
  } = await import('./filesystem/default-graphql-filesystem.mjs');
