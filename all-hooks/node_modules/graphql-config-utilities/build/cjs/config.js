...
function resolvePathRelativeToConfig(project, relativePath) {
  return path.resolve(project.dirpath, relativePath);
}
...
function resolveSchemaPath(project, ignoreMissing = false) {
  ...
  const schemaPath = path.resolve(project.dirpath, project.schema);
  if (ignoreMissing) {
    return schemaPath;
  }
...
async function getGraphQLProjectIncludedFilePaths(projectConfig) {
  ...
  return (await Promise.all(includes.map(include => util.promisify(glob__default["default"])(resolvePathRelativeToConfig(projectConfig, include), {
...
exports.defaultGraphQLProjectName = defaultGraphQLProjectName;
...
exports.getGraphQLProjects = getGraphQLProjects;
exports.getGraphQLSchemaPaths = getGraphQLSchemaPaths;
exports.getIncludesExcludesFromConfig = getIncludesExcludesFromConfig;
exports.resolvePathRelativeToConfig = resolvePathRelativeToConfig;
